  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <motion.div
        ...
        className="w-8 h-8 border-2 border-[#2251FF] border-t-transparent rounded-full"
      />
    </div>
  )
}
      ...
      <BrowserRouter>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            {/* Consumer routes */}
            <Route path="/consumer/post" element={
              <RequireAuth role="consumer">
                <AppLayout showFooter={false}><PostEventPage /></AppLayout>
              </RequireAuth>
            } />
            <Route path="/consumer/events" element={
              <RequireAuth role="consumer">
                <AppLayout><ConsumerEventsPage /></AppLayout>
              </RequireAuth>
            } />
            <Route path="/consumer/dashboard" element={
              <RequireAuth role="consumer">
                <AppLayout><ConsumerDashboardPage /></AppLayout>
              </RequireAuth>
            } />
            ...
            <Route path="/vendor/events" element={
              <RequireAuth role="vendor">
                <AppLayout><VendorEventsPage /></AppLayout>
              </RequireAuth>
            } />
            <Route path="/vendor/dashboard" element={
              <RequireAuth role="vendor">
                <AppLayout><VendorDashboardPage /></AppLayout>
              </RequireAuth>
            } />
            <Route path="/vendor/bids" element={
              <RequireAuth role="vendor">
                <AppLayout><VendorBidsPage /></AppLayout>
              </RequireAuth>
            } />
            <Route path="/vendor/profile/setup" element={
              <RequireAuth role="vendor">
                <AppLayout showFooter={false}><VendorProfileSetupPage /></AppLayout>
              </RequireAuth>
            } />
            ...
            <Route path="/payment/:bookingId" element={
              <RequireAuth>
                <AppLayout showFooter={false}><PaymentPage /></AppLayout>
              </RequireAuth>
            } />
            <Route path="/notifications" element={
              <RequireAuth>
                <AppLayout showFooter={false}><NotificationsPage /></AppLayout>
              </RequireAuth>
            } />
